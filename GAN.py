...
file_number = 'MOMENTUM_GANs/1/neg_0'
training_files = 'neg13_0_0_first_norm.npy'
save_name = 'neg13_0_0'
is_it_x = False

location_of_training_files = '/mnt/storage/scratch/am13743/FULL_TRAINING_DATA/'
storage_location = '/mnt/storage/scratch/am13743/'
min_max_location = '/mnt/storage/scratch/am13743/FULL_GAN_MIN_MAX/'
...
##############
# - pos x x -  -l 0.0002 -nG 6 -nD 3 -layersG 2 -layersD 2
# - pos 0 0 -  -l 0.0002 -nG 2 -nD 3 -layersG 2 -layersD 2
# - neg x x -  -l 0.0002 -nG 6 -nD 3 -layersG 2 -layersD 2
# - neg 0 0 -  -l 0.0002 -nG 2 -nD 3 -layersG 2 -layersD 2
##############
...
class GAN(object):
	...
	def __init__(self, width=1, height=dimensions, channels=1):
